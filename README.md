...
### Step A: Download Large Assets (Required)
Due to file size limits, the Model and Dataset files are hosted externally.
...
### **Verify Status**
* Check that all 6 containers are running: docker-compose ps

### Python Application Setup
1. **Install Dependencies:** pip install -r requirements.txt
2. **Start the AI Engine:** Open Terminal #1: python src/processor.py
